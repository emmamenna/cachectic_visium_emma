...
```{r}
pb <- readRDS("~/pb_nuclei.rds")
pb_musc <- pb[,pb$cell_type == "MuSC"]
pb_musc_rid <- pb_musc[,pb_musc$sampletype %in% c("sham", "c26", "c26murf1")]
...
df$sampletype <- pb_musc_rid$sampletype
...
# Dotplot
ggplot(df_sum, aes(x = sampletype, y = gene)) +
