...
#Blocco1 fox0
c26foxO_b1 <- gfp_transfer(parquet_list[[1]], spe_list$blocco1_c26foxO, subset_list$c26foxO_b1)
...
#Blocco1 STAT3
subset_list$c26STAT3_b1$in_treatment <- rep(TRUE,dim(subset_list$c26STAT3_b1)[2])

#Blocco2 HA PROBLEMI !!!

#Blocco3 murf1
c26murf1_b3 <- gfp_transfer(parquet_list[[3]], spe_list$blocco3_c26murf1, subset_list$c26murf1_b3)
...
#Blocco4 fox0
c26foxO_b4 <- gfp_transfer(parquet_list[[4]], spe_list$blocco4_c26foxO, subset_list$c26foxO_b4)
...
#Blocco4 
c26SMAD23_b4 <- gfp_transfer(parquet_list[[4]], spe_list$blocco4_c26SMAD23, subset_list$c26SMAD23_b4)
...
#Blocco 4 C26
subset_list$c26_b4$in_treatment <- rep(FALSE,dim(subset_list$c26_b4)[2])

#Blocco5 smad
c26SMAD23_b5 <- gfp_transfer(parquet_list[[5]], spe_list$blocco5_c26SMAD23, subset_list$c26SMAD23_b5)
...
#Blocco5 murf1
c26murf1_b5 <- gfp_transfer(parquet_list[[5]], spe_list$blocco5_c26murf1, subset_list$c26murf1_b5)
...
#Blocco5 stat3
subset_list$c26STAT3_b5$in_treatment <- rep(TRUE,dim(subset_list$c26STAT3_b5)[2])

#Blocco6 fox0
c26foxO_b6 <- gfp_transfer(parquet_list[[6]], spe_list$blocco6_c26foxO, subset_list$c26foxO_b6)
...
#Blocco6 c26
subset_list$c26_b6$in_treatment <- rep(FALSE,dim(subset_list$c26_b6)[2])

#Blocco9 fox0
c26foxO_b9 <- gfp_transfer(parquet_list[[7]], spe_list$blocco9_c26foxO, subset_list$c26foxO_b9)
...
#Blocco9 murf
c26murf1_b9 <- gfp_transfer(parquet_list[[7]], spe_list$blocco9_c26murf1, subset_list$c26murf1_b9)
...
#Blocco9 smad
c26SMAD23_b9 <- gfp_transfer(parquet_list[[7]], spe_list$blocco9_c26SMAD23, subset_list$c26SMAD23_b9)
...
save(subset_list,file="subset_list_gfp.RData")
