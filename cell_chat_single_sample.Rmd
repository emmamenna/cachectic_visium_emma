...
#NB: SALVATO SUBSET_LIST FILTRATA E FILTRATA + SPANORM
...
cellchat_list <- lapply(subset_list, function(spx) {
  ...
  chat <- computeCommunProb(chat, type = "triMean", scale.distance = 0.1, contact.dependent = FALSE)
  chat <- computeCommunProbPathway(chat)
  chat <- aggregateNet(chat)
  chat
})

#CONTACT DEPENDENT TRUE O FALSE? INTANTO METTO FALSE
#mi dice di alzare scale.distance
